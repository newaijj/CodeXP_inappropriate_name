...
class JobAppCard extends StatelessWidget {
  final Job job;
  final VoidCallback callback;
  const JobAppCard({Key key, this.job, this.callback}) : super(key: key);
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Row(
                  children: <Widget>[
                    Container(child: Icon(FontAwesomeIcons.tasks),),
                    SizedBox(width: 8,),
                    Center(child: Text("Application Processing")),
                  ],
                ),
                SizedBox(height: 8),
              ],
